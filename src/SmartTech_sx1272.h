#ifndef __SMARTTECH_SX1272_H__
#define __SMARTTECH_SX1272_H__
 ...
 */
typedef struct __packed sLoRaSettings
{
...
#define DEFAULT_LORA_SETTINGS {   \
	.RFFrequency      = 868300000,\
	.Power            = 20,       \
	.SignalBw         = 2,        \
	.SpreadingFactor  = 7,        \
	.ErrorCoding      = 1,        \
	.CrcOn            = true,     \
	.ImplicitHeaderOn = false,    \
	.RxSingleOn       = 1,        \
	.FreqHopOn        = 0,        \
	.HopPeriod        = 4,        \
	.TxPacketTimeout  = 500,      \
...
typedef struct sRadioDriver
{
    void     ( *init )       ( void );
    void     ( *reset )      ( void );
    void     ( *setConfig )  ( tLoRaSettings* settings );
    void     ( *setPinVDD )  ( uint8_t pin );
    void     ( *setPinCTRL ) ( uint8_t pin );
    void     ( *setPinDIO )  ( uint8_t num, uint8_t pin );
	void     ( *setVDD )     ( uint8_t state );
    void     ( *startRx )    ( void );
