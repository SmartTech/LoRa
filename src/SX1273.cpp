...
SX1273::SX1273(SPIClass* _spi, int nss, float freq, Bandwidth bw, SpreadingFactor sf, CodingRate cr, int dio0, int dio1) :
SX1272(_spi, nss, freq, bw, sf, cr, dio0, dio1)
{
  
}

uint8_t SX1273::config(Bandwidth bw, SpreadingFactor sf, CodingRate cr, float freq) {
