...
SX1279::SX1279(SPIClass* _spi, int nss, float freq, Bandwidth bw, SpreadingFactor sf, CodingRate cr, int dio0, int dio1) :
	SX1278(_spi, nss, freq, bw, sf, cr, dio0, dio1)
{
  
}

uint8_t SX1279::config(Bandwidth bw, SpreadingFactor sf, CodingRate cr, float freq) {
